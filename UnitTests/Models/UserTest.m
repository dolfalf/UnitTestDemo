...
- (void)testDesignatedInitializer {
	User *user = [[[User alloc] initWithUsername:@"stevevai" fullname:@"Steve Vai"] autorelease];
...
- (void)testDescription {
	User *user = [[[User alloc] initWithUsername:@"satch" fullname:@"Joe Satriani"] autorelease];
